...
const List<Reciter> defaultReciters = [
  ...
  Reciter(
    ...
    avatarUrl: 'lib/assets/images/reciters/mishary rashid alafasy.png',
    priority: 1,
  ...
  Reciter(
    ...
    avatarUrl: 'lib/assets/images/reciters/abdulbasit-abdulsamad.png',
    priority: 2,
  ...
  Reciter(
    ...
    avatarUrl: 'lib/assets/images/reciters/abdulrehman as-sudais.png',
    priority: 4,
    audioSource: AudioSource.quranCom,
  ...
  Reciter(
    ...
    country: 'Saudi Arabia',
    description: 'Imam of Masjid al-Haram, Makkah',
    avatarUrl: 'lib/assets/images/reciters/sa\'ud as shuraim.png',
    priority: 5,
    audioSource: AudioSource.quranCom,
  ...
  Reciter(
    ...
    avatarUrl: 'lib/assets/images/reciters/hani ar rifai.png',
    priority: 6,
    audioSource: AudioSource.quranCom,
    audioPath: 'Rifai/mp3',
  ),
  ...
  Reciter(
    ...
    avatarUrl: 'lib/assets/images/reciters/maher al-muaiqly.png',
    priority: 7,
    audioSource: AudioSource.alquranCdn,
  ...
  Reciter(
    ...
    avatarUrl: 'lib/assets/images/reciters/Mahmud_Khalil_al-Husary.png',
    priority: 8,
    audioSource: AudioSource.alquranCdn,
    audioPath: 'ar.husary',
  ),
  ...
  Reciter(
    ...
    avatarUrl: 'lib/assets/images/reciters/ali al-hudhaify.png',
    priority: 10,
    audioSource: AudioSource.alquranCdn,
  ...
  Reciter(
    ...
    avatarUrl: 'lib/assets/images/reciters/muhammad ayyoub.png',
    priority: 11,
    audioSource: AudioSource.alquranCdn,
  ...
  Reciter(
    ...
    avatarUrl: 'lib/assets/images/reciters/ahmed-al-ajmy.png',
    priority: 12,
    audioSource: AudioSource.alquranCdn,
  ...
  Reciter(
    ...
    avatarUrl: 'lib/assets/images/reciters/abu bakr-ash-shatri.png',
    priority: 13,
    audioSource: AudioSource.alquranCdn,
  ...
  Reciter(
    ...
    avatarUrl: 'lib/assets/images/reciters/muhammad jibreel.png',
    priority: 14,
    audioSource: AudioSource.alquranCdn,
  ...
  Reciter(
    ...
    avatarUrl: 'lib/assets/images/reciters/muhammad siddiq al minshawi.png',
    priority: 15,
    audioSource: AudioSource.quranCom,
