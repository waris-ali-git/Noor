  ...
  static Color getTajweedColor(TajweedRule rule) {
    switch (rule) {
      ...
      case TajweedRule.ghunnah:
        return const Color(0xFFEF5D74); // Coral Red
      ...
      case TajweedRule.heavy:
        return const Color(0xFF8ABDE3); // Light Blue
